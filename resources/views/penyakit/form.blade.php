                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Penyakit</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nama Penyakit">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Deskripsi</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Deskripsi">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Gejala</label>
                      <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Gejala">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Pengobatan</label>
                      <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Pengobatan">
                    </div>
